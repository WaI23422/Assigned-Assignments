...
/**
 *  Find the minimum element and place the minimum element at the beginning. Repeat the same process for the remaining elements. (based on Binary Heap data structure.)
 */
