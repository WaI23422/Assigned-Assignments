...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/intersection-of-two-linked-lists/">160.Intersection of Two Linked Lists</a>
 * 
    ...
    public static void main(String[] args) {
        ...
        for (int[][] test : tests) {
            ListNode headA = ListNode.addNode(test[0], 0), 
                     headB = ListNode.addNode(test[1], 0);
            ListNode ans = new IntersectionOfTwoLinkedLists_Solution().getIntersectionNode(headA, headB);
            System.out.println(ans == null? null : ans.toString());
        }
    }
}

// @see BetterCodeAnswer.Array.LinkeList.IntersectionOfTwoLinkedLists
