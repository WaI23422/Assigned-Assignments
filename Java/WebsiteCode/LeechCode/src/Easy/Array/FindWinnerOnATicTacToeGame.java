...
/**
 * <a class="mr-2 text-label-1 dark:text-dark-label-1 hover:text-label-1 dark:hover:text-dark-label-1 text-lg font-medium" href="/problems/find-winner-on-a-tic-tac-toe-game/">1275.Find Winner on a Tic Tac Toe Game</a>
 * 
 * <div class="px-5 pt-4"><div class="flex"></div><div class="xFUwe" data-track-load="description_content"><p><strong>Tic-tac-toe</strong> is played by two players <code>A</code> and <code>B</code> on a <code>3 x 3</code> grid. The rules of Tic-Tac-Toe are:</p>
...
public class FindWinnerOnATicTacToeGame{
    public static void main(String[] args) {
        ...
        FindWinnerOnATicTacToeGame_Solution res = new FindWinnerOnATicTacToeGame_Solution();
...
class FindWinnerOnATicTacToeGame_Solution {
    // 0 ms
    // 39.66 MB
    public String tictactoe(int[][] moves) {
        int[] row = new int[3], col = new int[3];
        int track = 0, valPlayer = 1, dig = 0, anti_dig = 0, totalMove = 0;
        ...
        for (int[] move : moves) {
            ...
            if (Math.abs(move[0] - move[1]) == 2 || (move[0] == move[1] && move[0] == 1)) {
                anti_dig += valPlayer;
            }
        ...
        if (dig == 3 || col[0] == 3 || col[1] == 3 || col[2] == 3 || row[0] == 3 || row[1] == 3 || row[2] == 3 || anti_dig == 3) {
            return "A";
        } else if (dig == -3 || col[0] == -3 || col[1] == -3 || col[2] == -3 || row[0] == -3 || row[1] == -3 || row[2] == -3 || anti_dig == -3) {
            return "B";
        }
