...
public class MoveZeros {
    public static void main(String[] args) {
        int[] number = {0,0,0,3,12};

        MoveZeros_Solution answer = new MoveZeros_Solution();

        answer.moveZeroes(number);
