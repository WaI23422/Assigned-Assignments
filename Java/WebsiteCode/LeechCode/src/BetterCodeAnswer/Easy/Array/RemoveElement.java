...
/**
 * <a class="mr-2 text-label-1 dark:text-dark-label-1 hover:text-label-1 dark:hover:text-dark-label-1 text-lg font-medium" href="/problems/remove-element/">27.Remove Element</a>
 * 
...
public class RemoveElement {
    public static void main(String[] args) {
        ...
        for (int[][] test : tests) {
            int[] nums = test[0];
            int val = test[1][0];
            System.out.println(new RemoveElement_Solution().removeElement(nums,val));
        }
    }
}

// @see Easy.Array.RemoveElement.java
