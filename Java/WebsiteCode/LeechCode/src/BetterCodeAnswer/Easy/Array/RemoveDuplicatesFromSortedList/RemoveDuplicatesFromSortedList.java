package BetterCodeAnswer.Easy.Array.RemoveDuplicatesFromSortedList;
    ...
    public static void main(String[] args) {
        ...
        for (int[] test : tests) {
            ...
            for (int i = test.length-1; i >= 1; i--) {
                ListNode body = new ListNode(test[i],head.next);
                head.next = body;
            }
...
// @see Easy.Array.RemoveDuplicatesFromSortedList.java
