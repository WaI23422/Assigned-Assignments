...
public class SignOfTheProductOfAnArray {
    public static void main(String[] args) {
        ...
        SignOfTheProductOfAnArray_Solution result = new SignOfTheProductOfAnArray_Solution();

        System.out.println(result.arraySign(nums));
    } 
}

class SignOfTheProductOfAnArray_Solution {
    // 0 ms
    // 42.9 MB
