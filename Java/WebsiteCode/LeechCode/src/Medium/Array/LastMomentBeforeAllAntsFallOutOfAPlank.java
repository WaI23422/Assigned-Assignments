...
/**
 * <a class="mr-2 text-label-1 dark:text-dark-label-1 hover:text-label-1 dark:hover:text-dark-label-1 text-lg font-medium" href="/problems/last-moment-before-all-ants-fall-out-of-a-plank/">1503.Last Moment Before All Ants Fall Out of a Plank</a>
 * 
 * <div class="px-5 pt-4"><div class="flex"></div><div class="xFUwe" data-track-load="description_content"><p>We have a wooden plank of the length <code>n</code> <strong>units</strong>. Some ants are walking on the plank, each ant moves with a speed of <strong>1 unit per second</strong>. Some of the ants move to the <strong>left</strong>, the other move to the <strong>right</strong>.</p>
...
public class LastMomentBeforeAllAntsFallOutOfAPlank {
    public static void main(String[] args) {
        ...
        LastMomentBeforeAllAntsFallOutOfAPlank_Solution res = new LastMomentBeforeAllAntsFallOutOfAPlank_Solution();
        ...
        for (int[][] test : tests) {
            ...
            System.out.println(res.getLastMoment(n, left, right));
        }
    }
}

class LastMomentBeforeAllAntsFallOutOfAPlank_Solution {
    public int getLastMoment(int n, int[] left, int[] right) {

        // @see BetterCodeAnswer.Medium.Array.LastMomentBeforeAllAntsFallOutOfAPlank.java;
